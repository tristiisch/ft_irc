...
/*   Updated: 2022/05/23 17:47:59 by alganoun         ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
			...
			if (args[0][0] == '#'){
				...
				if (args[1].compare("+o")){
					...
					if (ret < 0){
						...
						client->recieveMessage(RPL_UNIQOPIS(args[2], channel->getName()));
						channel->sendMessageToAll(client, RPL_UNIQOPIS(args[2], channel->getName()));
						return true;
					}
				}
