...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/05/05 14:59:06 by allanganoun       #+#    #+#             */
/*   Updated: 2022/05/05 15:54:04 by allanganoun      ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
namespace ft {
	...
	bool ServerIRC::stop() {
		...
		for (it = clients.begin(); it != clients.end(); it++) {
			...
			delete it->second; // ici je pense qu'on peut juste zapper ça avec le destructeur de Client
		}
		clients.clear();
